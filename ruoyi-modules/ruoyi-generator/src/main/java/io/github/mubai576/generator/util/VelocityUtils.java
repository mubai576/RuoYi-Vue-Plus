package io.github.mubai576.generator.util;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("io.github.mubai576.common.translation.annotation.Translation");
                importList.add("io.github.mubai576.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
